...
import type {
    basicInfo, changeInfo, disabilityInfo,
    economicInfo, getbasicInfo, getdisabilityInfo,
    getHealthInfo, healthInfo, politicalInfo, propertyInfo,
    WarrantorType
} from '../../Add/types';
...
import {
    ...
    disItem,
    disName,
    ecoItem, ecoName, healthItem, healthName,
    politicalItem, politicalName, proItem, proName, warItem, warName
} from './objectName';
...
const Warrantor = ({ porform, ecomomicform, disform, disUpdateData,
    healthform, basicform, eduform, basicData, HealthInfoData,
    EducationData, ProductionData, OtherInfoData, warData, imgSrc }: props) => {
    ...
    const handleSubmit = () => {
        ...
        ecomomicform?.validateFields().then(() => {
            console.log('e');
        ...
        healthform?.validateFields().then(() => {
            console.log('h');
    ...
    return (
        <>
            ...
            <Button
                ...
                type='primary'
                onClick={() => setUrgencyVisible(true)}>保存</Button>
