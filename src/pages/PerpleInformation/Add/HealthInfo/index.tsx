...
const HealthInfo = ({ form, healthData, disData, disform }: props) => {
    ...
    const openDisability = (e: any) => {
        if (e === '残疾人') {
            ...
            setOpenDis(false);
            form.resetFields(['disabilityId', 'disabilityType',
                'disabilitySubsidy', 'disabilityLevel', 'servereDisabilitySub']);
        }
    };
                        ...
                        <Row>
                            <Col span={6}>
                                <Form.Item
                                    ...
                                    <Select style={{ width: '11vw' }}>
                                        ...
                                        <Option key={1} value='离异'>离异</Option>
                                        <Option key={1} value='丧偶'>丧偶</Option>
                                    </Select>
                                </Form.Item>
                            </Col>
                            <Col span={6}>
                            ...
                            <Col span={6}>
                                <Form.Item
                                    ...
                                    label="医疗保险情况:">
                                    <Select style={{ width: '11vw' }}>
                                        <Option key={1} value='职工保险'>职工保险</Option>
                                        <Option key={2} value='社会保险'>社会保险</Option>
                                        <Option key={1} value='个人保险'>个人保险</Option>
                                        <Option key={1} value='无'>无</Option>
                                    </Select>
                                </Form.Item>
                            </Col>
                            <Col span={6}>
                            ...
                            <Row>
                                <Col span={6}>
                                    <Form.Item
                                        ...
                                        label="残疾级别:">
                                        <Input
                                            placeholder='请填写残疾级别为:1-10' style={{ width: '11vw' }} />
                                    </Form.Item>
                                </Col>
                                <Col span={6}>
                                    <Form.Item
                                        name="servereDisabilitySub"
                                        label="重度残疾人护理补贴:">
                                        <Input placeholder='请填写' style={{ width: '11vw' }} />
                                    </Form.Item>
                                </Col>
