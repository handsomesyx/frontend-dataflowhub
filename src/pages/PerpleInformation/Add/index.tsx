  ...
  const itemConfig: ItemConfigType[] = [
    {
      ...
      elem: <BasicInfo form={basicForm} update={false} imgSrc={imgSrc} setImgSrc={setImgSrc} />
    },
    // { id: 2, name: '专群结合', href: 'combination2', elem: <>1</> },
    // { id: 3, name: '民生', href: 'wellbeing3', elem: <>1</> },
    {
      id: 2, name: '民政卫健', href: 'administration4',
    ...
    { id: 4, name: '生产经营情况', href: 'production5', elem: <EconomicInfo form={ecomomicForm} /> },
    {
      id: 5, name: '其他情况', href: 'otherInformation6',
      elem: <PorpertyInfo porform={porForm} ecomomicform={ecomomicForm} imgSrc={imgSrc}
        healthform={healthForm} basicform={basicForm} eduform={eduForm} update={false}
        disform={disForm} />
    },
