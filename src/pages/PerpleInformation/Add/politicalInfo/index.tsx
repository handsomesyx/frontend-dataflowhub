        ...
        <div className={styles.Basic}>
          <Form labelCol={{ span: 6 }} form={form}>
            ...
            <Row>
              <Col span={8}>
                ...
                >
                  <Select style={{ width: '15vw' }}>
                    <Option key={1} value="中共党员">
                      中共党员
                    </Option>
                    <Option key={2} value="共青团员">
                      共青团员
                    </Option>
                    <Option key={1} value="群众">
                      群众
                    </Option>
                  </Select>
                </Form.Item>
              ...
              <Col span={8}>
                <Form.Item name="partyOrganization" label="所属党团组织:">
                  <Input placeholder="请填写" style={{ width: '15vw' }} />
                </Form.Item>
              </Col>
              <Col span={8}>
            ...
            <Row>
              ...
              <Col span={8}>
                ...
                >
                  <Select style={{ width: '15vw' }}>
                    <Option key={1} value="未服兵役">
                      未服兵役
                    </Option>
                    <Option key={2} value="入伍">
                      入伍
                    </Option>
                    <Option key={3} value="退伍">
                      退伍
                    </Option>
                  </Select>
                </Form.Item>
