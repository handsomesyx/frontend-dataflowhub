          ...
          <Form form={form}>
            ...
            {plantingOn ? (
              <>
                <Row>
                  <Col span={6}>
                    <Form.Item name="plantType" label="种植种类:">
                      <Input placeholder="请填写" style={{ width: '11vw' }} />
                    </Form.Item>
                  </Col>
                  <Col span={6}>
                    <Form.Item name="plantQuantity" label="种植数量:">
                      <Input placeholder="请填写" style={{ width: '11vw' }} />
                    </Form.Item>
                  </Col>
                  <Col span={6}>
                    <Form.Item name="plantArea" label="种植面积:">
                      <Input placeholder="请填写" style={{ width: '11vw' }} />
                    </Form.Item>
                  </Col>
                </Row>
                <Row>
                  <Col span={6}>
                    <Form.Item name="breedingType" label="养殖种类:">
                      <Input placeholder="请填写" style={{ width: '11vw' }} />
                    </Form.Item>
                  </Col>
                  <Col span={6}>
                    <Form.Item name="breedingQuantity" label="养殖数量:">
                      <Input placeholder="请填写" style={{ width: '11vw' }} />
                    </Form.Item>
                  </Col>
                </Row>
            ...
            {bussinessOn ? (
              <>
                <Row>
                  <Col span={12}>
                    <Form.Item name="bussinessInfo" label="商户名称:">
                ...
                <Row>
                  <Col span={12}>
                    <Form.Item name="businessLocation" label="门面位置:">
                      <Input placeholder="请输入" style={{ width: '29vw' }} />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item name="licenseNum" label="营业执照编号:">
                ...
                <Row>
                  <Col span={6}>
                    <Form.Item name="fireEquipmentType" label="门面消防设备类型:">
                      <Input placeholder="请输入" style={{ width: '10vw' }} />
                    </Form.Item>
                  </Col>
                  <Col span={6}>
                    <Form.Item name="fireEquipmentQuantity" label="门面消防设备数量:">
                      <Input placeholder="请填写" style={{ width: '7.6vw' }} />
                    </Form.Item>
                  </Col>
                  <Col span={6}>
                    <Form.Item name="surStatus" label="门面电子监控状态:">
                      <Input placeholder="请输入" style={{ width: '10vw' }} />
                    </Form.Item>
                  </Col>
                  <Col span={6}>
                    <Form.Item name="surQuantity" label="门面电子监控数量:">
                      <Input placeholder="请填写" style={{ width: '7.6vw' }} />
                    </Form.Item>
                  </Col>
                </Row>
