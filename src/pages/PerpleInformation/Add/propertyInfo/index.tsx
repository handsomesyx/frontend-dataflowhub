...
import type {
    basicCreateInfo,
    basicInfo, disabilityInfo, economicInfo,
                            ...
                            <Col span={8}>
                                <Form.Item
                                    ...
                                    <Select style={{ width: '11vw' }}>
                                        <Option key={1} value='常住户'>常住户</Option>
                                        <Option key={2} value='租房户'>租房户</Option>
                                    </Select>
                                </Form.Item>
                            </Col>
                            <Col span={8}>
                        ...
                        <Row>
                            <Col span={8}>
                                <Form.Item
                                    ...
                                    label="房屋类型:">
                                    <Select style={{ width: '11vw' }}>
                                        <Option key={1} value='危房'>危房</Option>
                                        <Option key={2} value='非危房'>不是危房</Option>
                                    </Select>
                                </Form.Item>
                            </Col>
                            <Col span={8}>
