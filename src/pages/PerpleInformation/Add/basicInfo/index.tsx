...
const BasicInfo = ({ form, basicUpdateData,
    familyUpdateData, update, imgSrc, setImgSrc }: props) => {
            ...
            <div className={styles.Container}>
                <div className={styles.Basic}>
                    ...
                    <Button
                        ...
                        onClick={() => setManyVisible(true)}>批量导入</Button>
                                            ...
                                            <Col span={8}>
                                                <Form.Item
                                                    ...
                                                    <Select style={{ width: '15vw' }}>
                                                        <Option key={1} value={false}>男</Option>
                                                        <Option key={2} value={true}>女</Option>
                                                    </Select>
                                                </Form.Item>
                                            </Col>
                                        </Row>
                ...
                <div className={styles.Basic}>
                    ...
                    <div className={styles.FormInput}>
                        {update ? <>
                            ...
                            <Button type='primary'
                                onClick={() => setAddVisible(true)}>添加家庭成员</Button></> : <></>}
                        <div className={styles.FamilyBox}>
                            {familyData ? familyData?.map((item: familyDataType, index: number) => {
                                return (
