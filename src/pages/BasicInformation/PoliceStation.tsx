    ...
    const PoliceStation_card = (
        policeStation.map((item: PoliceType, index) => {
            ...
            return (
                <>
                    <Col span={6}>
                        <Card hoverable style={{ marginBottom: '1vh' }} key={index} actions={[
                    ...
                    <Row gutter={16} style={{ columnGap: '20px' }}>
                        ...
                        <Form.Item>
                            <Button
                                ...
                                htmlType='submit'
                                style={{
                                    background: '#0757CB', fontSize: '14px',
            ...
            >
                <Form form={formAddPolice} layout='vertical'>
                    <Form.Item name="nameInfo">
                        <Input placeholder='请输入搜索关键字' suffix={<SearchOutlined onClick={() => {
                    ...
                    updatePoliceStation({
                        variables: {
                            new_data: {
                                administrative_area_id: administrative_area_id,
                                // community_id: 0,
                                name: formupdatePoliceStation.
                                    getFieldValue('policeStationname'),
                                user_id: userID,
                            },
